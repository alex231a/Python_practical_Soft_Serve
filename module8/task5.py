...
class Worker:
    ...
    def get_tax_value(self):
        if self.salary <= 1000:
            ...
            tax = 0.10 * 2000 + 0.15 * 2000 + 0.21 * 5000 + 0.30 * (self.salary - 10000)
        elif 20001 <= self.salary <= 50000:
            tax = 0.10 * 2000 + 0.15 * 2000 + 0.21 * 5000 + 0.30 * 10000 + 0.40 * (self.salary - 20000)
        else:
            tax = 0.10 * 2000 + 0.15 * 2000 + 0.21 * 5000 + 0.30 * 10000 + 0.40 * 30000 + 0.47 * (self.salary - 50000)
